---
title: Parallel scan + Limit interaction gap
type: note
summary: "A ScanRequest with both TotalSegments and Limit applies Limit before the segment filter; real DynamoDB applies Limit within the segment."
tags: [release, v1.1, known-limitation, parallel-scan]
created: 2026-05-15
status: evolving
refines: "[[parity-with-dynamodb-local]]"
...
Model segmentation by adding a stable per-row partition hash column to the storage schema and pushing the segment filter into SQLite.

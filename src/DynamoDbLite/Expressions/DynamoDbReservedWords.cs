...
// Match is case-insensitive. Identifiers escaped via ExpressionAttributeNames (#name) are exempt.
internal static class DynamoDbReservedWords
{
    ...
    internal static bool IsReserved(string name) => Words.Contains(name);

    internal static void Validate(string name, string expressionKind)
    {

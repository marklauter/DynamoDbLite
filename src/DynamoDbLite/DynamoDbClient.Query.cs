...
// Shared helpers near the bottom (ConvertConditionsToExpression, BuildKeyAttributeValue,
// BuildLastEvaluatedKey, BuildIndexLastEvaluatedKey, ApplyIndexProjection, ...) are also
// used by the Scan partial in DynamoDbClient.Scan.cs.
